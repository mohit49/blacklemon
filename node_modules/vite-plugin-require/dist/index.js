            ...
            return __awaiter(this, void 0, void 0, function () {
                ...
                return __generator(this, function (_a) {
                    ...
                    if (fileRegex.test(id)) {
                                    ...
                                    if (arg) {
                                        ...
                                        if (stringVal_1) {
                                            ...
                                            if (translateType === "import") {
                                                var importAst = types_1.importDeclaration([types_1.importDefaultSpecifier(types_1.identifier(realPath))], types_1.stringLiteral(stringVal_1));
                                                ...
                                                switch (arg === null || arg === void 0 ? void 0 : arg.type) {
                                                    ...
                                                    case "Identifier":
                                                        ...
                                                        break;
                                                    case "BinaryExpression":
                                                        path.container.arguments[0] = types_1.identifier(realPath);
                                                        break;
                                                    default:
                                                        throw "Unsupported type: " + (arg === null || arg === void 0 ? void 0 : arg.type);
                                                }
                                                ...
                                                var metaObj = types_1.memberExpression(types_1.memberExpression(types_1.identifier("import"), types_1.identifier("meta")), types_1.identifier("url"));
                                                var importAst = types_1.newExpression(types_1.identifier("URL"), [types_1.stringLiteral(stringVal_1), metaObj]);
                                                var hrefObj = types_1.expressionStatement(types_1.memberExpression(importAst, types_1.identifier("href")));
                                                var strCode = generator_1["default"](hrefObj, {}).code.replace(/\;$/, '');
                                                switch (arg === null || arg === void 0 ? void 0 : arg.type) {
                                                    case "StringLiteral":
                                                    ...
                                                    case "Identifier":
                                                        ...
                                                        break;
                                                    case "BinaryExpression":
                                                        path.container.arguments[0] = types_1.identifier(strCode);
                                                        break;
                                                    default:
                                                        throw "Unsupported type: " + (arg === null || arg === void 0 ? void 0 : arg.type);
                                                }
                        ...
                        output = generator_1["default"](ast_1, {
                            sourceMaps: true,
                            sourceFileName: id
                        }, code);
                        newCode = output.code;
